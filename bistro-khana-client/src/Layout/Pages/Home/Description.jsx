...
const Description = () => {
    return (
        <div style={{backgroundImage: `url(${chef})`}} className='bg-center bg-cover h-150 py-15 px-10 md:py-28 md:px-35'>
            <div className='bg-white py-5 md:py-24 mx-auto text-center px-5 md:px-30'>
